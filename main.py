...
╔═══════════════════════════════════════════════════════════════════════════╗
║  {0}OWNER      : ROHIT                                                 ║
║  {1}RULL3X     : MASTI TULES                                          ║
║  {1}FACEBOK    : ❮❮  ROHIT HERE🪽  ❯❯                                            ║
║  {2}RULS       : MULTI TOKEN CONVO                                           ║
║  {3}GITHUB     : ROHIT                                                   ║ 
║  {1}WH9TS9P    : +916005020676                                              ║
╚═══════════════════════════════════════════════════════════════════════════╝
    ...
    while True:
        for message_index, message in enumerate(messages):
            ...
            try:
                ...
                print(Fore.GREEN + f"└────────────────────────────────────────────────────────────────────┘\n")
                print(Fore.YELLOW + "\033[1;37m<<======== MADE BY ROHIT-EXOFORT😈🩷 ======>>")
                print("\n" + ("─" * 80) + "\n")
            except requests.exceptions.RequestException:
...
def main():
    ...
    pastebin_url = "https://pastebin.com/raw/yty4yTm8"  # URL of the pastebin containing the password
